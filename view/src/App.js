...
const App = () => {
    ...
    const fetchTodos = async () => {
        ...
        if (res.error) {
            ...
            // the controller returns res.json({data:task.rows}), so to access, the API takes care of getting .json(), but we need .json().data to actually access the returned data
        }
    }
